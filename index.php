	...
	<!-- Page Loder -->
								...
								<?php
									foreach ( $album_photos['data'] as $album_photo ) {
										...
										<li data-src="<?php echo $album_resized_cover_photo;?>">
											<div class="thumbnail no-border center col-lg-11" >
												
												<a href="<?php echo $album_photo['source'];?>" rel="<?php echo $album['id'];?>">
												  <img height="250px" width="250px" src="<?php echo $album_resized_cover_photo;?>" class="thm image-responsive img-rounded" alt="<?php echo $album['name'];?>" />
												</a>
												<div class="caption">
													<div class="row">
													<div class="row"><input type="checkbox" class="select-album" title="select album" value="<?php echo $album['id'].','.$album['name'];?>" />
													<?php $alb_nm = mb_substr($album['name'], 0, 15); ?></div>
													<div class="row"><h6><?php echo $alb_nm.' ('.count($album_photos['data']).')';?></h6></div>
													</div>
		...
		?>
			<div id="login-div" class="row">
				<a id="login-link" class="btn btn-primary btn-sm" href="<?php echo $helper->getLoginUrl( $perm );?>">Facebook</a>
			</div>
